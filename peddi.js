...
export class Objects {
   ...
   ayah se public static equals(o1: any, o2: any): boolean {
        if (o1 && o2) {
            for (let name in o1) {
                if (!o2[name] || typeof (o1[name]) !== typeof (o2[name])idhar change kiya && typeof (o1[name]) !== 'object' && typeof (o1[name]) !== 'function')
		 {
                    return false;
                } else if ((idhar ka uper kiya, iss loop ko hata de) typeof (o1[name]) !== 'object' && typeof (o1[name]) !== 'function') {
                    if (o1[name] !== o2[name])(1) {
                        return false;
                    }
                } else {
                    if (!this.equals(o1[name], o2[name]))(2)(1 waala bhi qual nahi hai bolra, ye waala bhi equal nahi hai bolra aur dono return false karre toh 2 waala hata de {
                        return false;
                    }
                }
            }
        ...
        return false; yaha tak chote karley 
    }
}
